        ...
        <main className="min-h-screen bg-gray-50 dark:bg-zinc-950">
            ...
            <div className="container mx-auto px-4 py-16 max-w-4xl space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {integrantes.map((i) => (
                            <div key={i.id} className="flex flex-col p-6 bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 shadow-sm">
                                <span className="text-lg font-bold text-gray-900 dark:text-gray-100">{i.firstName} {i.lastName}</span>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {tutores.map((t) => (
                            <div key={t.id} className="flex items-center gap-4 p-6 bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 shadow-sm">
