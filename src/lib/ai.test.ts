...
describe("AI Embedding Functions", () => {
    ...
    describe("generateEmbedding", () => {
        ...
        it("should throw error when API fails", async () => {
            ...
            vi.mocked(mockModel.embedContent).mockRejectedValue(
                new Error("API Error"),
            );
    ...
    describe("generateEmbeddingsBatch", () => {
        it("should generate embeddings for multiple texts", async () => {
            ...
            vi.mocked(mockModel.batchEmbedContents).mockResolvedValue(
                mockBatchResult,
            );
        ...
        it("should throw error when batch API fails", async () => {
            ...
            vi.mocked(mockModel.batchEmbedContents).mockRejectedValue(
